...
import com.example.pizzeriamobile.core.userdata.Favourite;
...
import com.example.pizzeriamobile.core.userdata.cart.model.CartItemType;
...
public class FoodBinder {
    ...
    private void setImage(){
        ImageView imageView = (ImageView) activity.findViewById(R.id.imageViewDialogFoodImage);
    ...
    final private View.OnClickListener onConfirmClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if(varietiesInCart.contains(variety.Id))
                Cart.handler.update(product, variety, amount);
            else
