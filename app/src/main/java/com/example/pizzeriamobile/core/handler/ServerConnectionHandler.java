package com.example.pizzeriamobile.core.handler;

import androidx.annotation.NonNull;

import com.example.pizzeriamobile.core.exception.InvalidRefreshToken;
    ...
    private boolean addJWTHeader(HttpPost httpPost, boolean isAccessToken){
        try{
            String JWT = isAccessToken ?
                    UserHandler.JWT.handler.getAccessJWT() :
                    UserHandler.JWT.handler.getRefreshJWT();
